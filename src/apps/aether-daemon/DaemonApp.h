...
public:
  ...
  void setForeground();
  void initLogging();
  void connectIpcServer(const aether::core::ipc::DaemonIpcServer *ipcServer) const;
...
private:
  ...
  aether::core::ipc::DaemonIpcServer *m_ipcServer = nullptr;
