...
public:
  ...
  // Regular functions
  //
  aether::Screen *openClientScreen();
  void closeClientScreen(aether::Screen *screen);
  ...
  Client *openClient(const std::string &name, const NetworkAddress &address, aether::Screen *screen);
