...
/**
 * @brief The AetherException class Generic aether exception class
 */
class AetherException : public BaseException
{
 ...
 */
class BadClientException : public AetherException
{
  using AetherException::AetherException;
 ...
 */
class InvalidProtocolException : public AetherException
{
  using AetherException::AetherException;
...
*/
class IncompatibleClientException : public AetherException
{
public:
...
*/
class DuplicateClientException : public AetherException
{
public:
...
*/
class UnknownClientException : public AetherException
{
public:
...
exit(int).
*/
class ExitAppException : public AetherException
{
public:
