 ...
 * @brief Aether Network Protocol Specification and Implementation
 *
 * @section protocol_overview Protocol Overview
 *
 * This file defines the data types, constants, and message structures for the
 * Aether network protocol. For a high-level conceptual overview of the protocol,
 ...
 *
 * @note When incrementing the minor version, the Aether application version should also increment
 * @since Protocol version 1.0
 */
static const int16_t kProtocolMinorVersion = 8;

/**
 * @brief Default TCP port for Aether connections
 *
