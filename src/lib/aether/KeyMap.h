...
private:
  ...
  using NameToKeyMap = std::map<std::string, KeyID, aether::string::CaselessCmp>;
  using NameToModifierMap = std::map<std::string, KeyModifierMask, aether::string::CaselessCmp>;
  ...
  // half-duplex info
  KeyButtonSet m_halfDuplex; // half-duplex set by aether
