...
*/
class StreamFilter : public aether::IStream
{
public:
  /*!
  ...
  d'tor.
  */
  StreamFilter(IEventQueue *events, aether::IStream *stream, bool adoptStream = true);
  ...
  */
  aether::IStream *getStream() const;
