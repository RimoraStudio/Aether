...
Q_SIGNALS:
  void error(aether::gui::CoreProcess::Error error);
  void logLine(const QString &line);
  void connectionStateChanged(aether::core::ConnectionState state);
  void processStateChanged(aether::core::ProcessState state);
  ...
  void connectionRefused(aether::core::ConnectionRefusal reason);
...
private:
  ...
  QTimer m_retryTimer;
  aether::gui::ipc::CoreIpcClient *m_coreIpcClient = nullptr;
