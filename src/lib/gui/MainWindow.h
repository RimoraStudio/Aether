...
namespace aether::gui::ipc {
class DaemonIpcClient;
}

class MainWindow : public QMainWindow
{
  using ConnectionState = aether::core::ConnectionState;
  using CoreMode = Settings::CoreMode;
  using CoreProcess = aether::gui::CoreProcess;
  using NetworkMonitor = aether::gui::NetworkMonitor;
  using ProcessState = aether::core::ProcessState;
...
private:
  ...
  void handleConnectionRefused(aether::core::ConnectionRefusal reason);
  ...
  inline static const auto m_guiSocketName = QStringLiteral("aether-gui");
  ...
  aether::gui::CoreProcess m_coreProcess;
  ...
  aether::gui::ipc::DaemonIpcClient *m_daemonIpcClient = nullptr;
