...
//! Aether server
/*!
This class implements the top-level server algorithms for aether.
*/
class Server
{
...
public:
  ...
  */
  Server(ServerConfig &config, PrimaryClient *primaryClient, aether::Screen *screen, IEventQueue *events);
