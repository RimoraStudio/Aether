...
private:
  ...
  KeyID getIDForKey(aether::KeyMap::KeyItem &item, KeyButton button, UINT virtualKey, PBYTE keyState, HKL hkl) const;

  void addKeyEntry(aether::KeyMap &keyMap, aether::KeyMap::KeyItem &item);
