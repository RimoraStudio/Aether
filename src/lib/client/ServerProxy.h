...
#include "aether/ClipboardTypes.h"
#include "aether/KeyTypes.h"
#include "aether/KeyboardLayoutManager.h"
...
public:
  ...
  \p client.
  */
  ServerProxy(Client *client, aether::IStream *stream, IEventQueue *events);
...
private:
  ...
  void requestRefuseConnection(aether::core::ConnectionRefusal reason, const char *message);
...
private:
  ...
  aether::KeyboardLayoutManager m_layoutManager;
};
