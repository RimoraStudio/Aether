...
#include "aether/IClient.h"

#include "base/Event.h"
#include "base/EventTypes.h"
#include "common/Enums.h"
#include "aether/IClipboard.h"
...
//! Aether client
/*!
This class implements the top-level client algorithms for aether.
*/
...
public:
  ...
  public:
    ...
    DisconnectRequest(aether::core::ConnectionRefusal reason, const char *message);
    ...
    aether::core::ConnectionRefusal refusalReason() const
    {
  ...
  private:
    ...
    aether::core::ConnectionRefusal m_refusalReason = aether::core::ConnectionRefusal::ProtocolError;
...
public:
  ...
  */
  void refuseConnection(aether::core::ConnectionRefusal reason, const char *msg);
...
private:
  ...
  void sendEvent(aether::EventTypes);
...
private:
  ...
  aether::Screen *m_screen = nullptr;
