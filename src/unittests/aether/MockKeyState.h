...
public:
  ...
  MockKeyState(const IEventQueue &eventQueue, const aether::KeyMap &keyMap)
      : KeyState((IEventQueue *)&eventQueue, (aether::KeyMap &)keyMap, {"en"}, true)
  {
  }
  ...
  void getKeyMap(aether::KeyMap &) override
  {
  }
