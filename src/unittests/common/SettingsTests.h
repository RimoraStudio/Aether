...
private:
  ...
  inline static const QString m_settingsFile = QStringLiteral("%1/Aether.conf").arg(m_settingsPathTemp);
  inline static const QString m_stateFile = QStringLiteral("%1/Aether.state").arg(m_settingsPathTemp);
